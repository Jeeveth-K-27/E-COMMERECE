...
const Hero = () => {
  return (
    <section className='relative'>
        <img src="src/assets/rabbit-hero.webp" alt="HeroSection" className='w-full h-[400px] md:h-[600px] lg:h-[750px] object-cover'/>
        ...
        <div className='absolute inset-0 bg-black bg-opacity-5 flex items-center justify-center'>
            <div className='text-center text-white p-6'>
                ...
                <Link to="#" className='bg-white text-gray-950 rounded-sm py-2 px-6 text-lg'>Shop Now</Link>
            </div>
        </div>
    </section>
  )
