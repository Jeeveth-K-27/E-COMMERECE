    ...
    <footer className='border-t py-12'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8 px-4'>
            ...
            <div className='space-y-4'>
                ...
                <p className='text-gray-500 mb-4'>Be the first to hear abut new products, <br />exclusive events and online offers.</p>
                <p className='font-medium text-sm textgray600'>Sign up and get 10% off on your first order.</p>

                <form action="" className='flex'>
                    <input type="email" placeholder='Enter your Email' className='p-2 w-full h-[50%] text-sm border-t border-b border-l
                     border-gray-300 rounded-l-md focus:outline-none focus:ring-2 ring-gray-500 transition-all' required/>

                    <button type='submit' className='bg-black text-white px-3 text-sm rounded-r-md hover:bg-gray-800 
        ...
        {/* footer bottom */}
        <div className='mt-12 px-4 border-t border-gray-200 pt-6'>
